...
namespace iPower.IRMP.Org.Poxy
{
    ...
    internal partial class AuthenticationServicePoxy : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        /// <remarks/>
        public AuthenticationServicePoxy()
        {
            this.Url = "http://irmp.yaesoft.net/Org/AuthenticationService.asmx";
        }
    ...
    internal partial class CallResult
    {
