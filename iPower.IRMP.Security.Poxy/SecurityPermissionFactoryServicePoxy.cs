...
namespace iPower.IRMP.Security.Poxy
{
    ...
    internal partial class SecurityPermissionFactoryServicePoxy : System.Web.Services.Protocols.SoapHttpClientProtocol
    {

        private System.Threading.SendOrPostCallback ModulePermissionsOperationCompleted;

        /// <remarks/>
        public SecurityPermissionFactoryServicePoxy()
        {
