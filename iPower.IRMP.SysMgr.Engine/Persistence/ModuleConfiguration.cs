...
namespace iPower.IRMP.SysMgr.Engine.Persistence
{
    ...
    public class ModuleConfigurationKeys : BaseModuleConfigurationKeys
    {
        ...
        /// 单点登录客户端程序集键。
        /// </summary>
        public const string SSOClientUserLoginAssemblyKey = "SSOClientUserLoginAssembly";
    }
    ...
    public class ModuleConfiguration : BaseModuleConfiguration
    {
        ...
        /// 单点登录客户端程序集。
        /// </summary>
        public IUserLogin SSOClientUserLoginAssembly
        {
            get
            {
                lock (this)
                {
                    IUserLogin userLogin = htbCache[ModuleConfigurationKeys.SSOClientUserLoginAssemblyKey] as IUserLogin;
                    if (userLogin == null)
                    {
                        userLogin = TypeHelper.Create(this[ModuleConfigurationKeys.SSOClientUserLoginAssemblyKey]) as IUserLogin;
                        if (userLogin != null)
                            htbCache[ModuleConfigurationKeys.SSOClientUserLoginAssemblyKey] = userLogin;
                     }
                    return userLogin;
                }
            }
